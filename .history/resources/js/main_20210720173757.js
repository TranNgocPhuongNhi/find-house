...
let sliderMaxValue = document.querySelector('.range-left').max;
...
function fillColor() {
    ...
    sliderTrack.style.background = `linear-gradient(to right, #dadae5 ${percent1}%, #3264fe ${percent1}%, #3264fe ${percent2}%, #da)`
}
