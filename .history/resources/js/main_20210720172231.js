...
minValue.addEventListener('input', sliderOne)
maxValue.addEventListener('input', sliderTwo)

function sliderOne() {
    if(parseInt(sliderTwo.value) - parseInt(minValue.value) <= minGap) {
        minValue.value = parseInt(sliderTwo.value) - minGap;
    }
}

function sliderTwo() {
    if(parseInt(sliderTwo.value) - parseInt(minValue.value) <= minGap) {
        sliderTwo.value = parseInt(minValue.value) + minGap;
    }
}
